...
{   
  ...
  public:
	...
	cout << "Value: " << val << endl;
      ...
      {
      sdf::ElementPtr elem = _sdf->GetElement("topic_prefix");
      elem->GetValue()->Get<std::string>(_topic_prefix);
      }
      else _topic_prefix = "/SENSORS";
	...
	return;
      ...
      _publisherGPS = _nodeHandle.advertise<sensor_msgs::NavSatFix>(_topic_prefix+"/GPS", 10);
	  _publisherIMU = _nodeHandle.advertise<sensor_msgs::Imu>(_topic_prefix+"/IMU", 10);
